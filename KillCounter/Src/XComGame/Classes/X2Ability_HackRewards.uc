	...
	optional int HitModValueB)
{
	...
	if( StatModValueA != 0.0 )
	{
		...
		StatChangeEffect.SetDisplayInfo(BuffType, Template.LocFriendlyName, Template.GetMyLongDescription(), Template.IconImage);
	...
	if( HitModValueA != 0 )
	{
		...
		AimEffect.SetDisplayInfo(BuffType, Template.LocFriendlyName, Template.GetMyLongDescription(), Template.IconImage);
