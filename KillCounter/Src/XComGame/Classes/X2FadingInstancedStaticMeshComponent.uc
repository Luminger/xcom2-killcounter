//---------------------------------------------------------------------------------------
//  FILE:    XComFadingInstancedStaticMeshComponent.uc
//  AUTHOR:  David Burchanowski
//  PURPOSE: Instanced static mesh component that transitions between two different static meshes
...
class X2FadingInstancedStaticMeshComponent extends InstancedStaticMeshComponent
	native(Core);
