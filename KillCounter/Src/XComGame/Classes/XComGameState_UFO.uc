...
//---------------------------------------------------------------------------------------
function OnCreation(XComGameState NewGameState, bool bGoldenPathSpawn)
{
...
function SetInterceptionChance(XComGameState NewGameState, bool bGoldenPathSpawn)
{
	...
	{
		IntChance = AfterFirstInterceptionChance[`DIFFICULTYSETTING];
	}
...
function FlyTo(XComGameState_GeoscapeEntity InTargetEntity, optional bool bInstantCamInterp = false)
{
	...
	NewUFOState = XComGameState_UFO(NewGameState.CreateStateObject(Class, ObjectID));
...
function XComGameState_MissionSiteAvengerDefense CreateAvengerDefenseMission(StateObjectReference RegionRef)
{
	...
	MissionState = XComGameState_MissionSiteAvengerDefense(NewGameState.CreateStateObject(class'XComGameState_MissionSiteAvengerDefense'));
...
{	
	...
	NewUFOState = XComGameState_UFO(NewGameState.CreateStateObject(class'XComGameState_UFO', ObjectID));
	NewGameState.AddStateObject(NewUFOState);
...
simulated public function UFOInboundPopup()
{
	...
	UFOState = XComGameState_UFO(NewGameState.CreateStateObject(class'XComGameState_UFO', self.ObjectID));
