...
native protected function EventListenerReturn XpEventResponse(name XpEvent, XpEventData EventData, XComGameState GameState, Name EventID);
...
function DistributeTacticalGameEndXp(XComGameState NewGameState)
{
	...
	if (Survivors.Length > 0)
	{
		...
		for (SurvivorIdx = 0; SurvivorIdx < Survivors.Length; ++SurvivorIdx)
		{
			...
			UnitState = XComGameState_Unit(NewGameState.CreateStateObject(class'XComGameState_Unit', Survivors[SurvivorIdx]));
...
//
function EventListenerReturn XpAllSoldiersSurvive(Object EventData, Object EventSource, XComGameState GameState, Name EventID)
{
	return XpEventResponse(GetFuncName(), XpEventData(EventData), GameState, EventID);
}

function EventListenerReturn XpPodCircumvented(Object EventData, Object EventSource, XComGameState GameState, Name EventID)
{
	return XpEventResponse(GetFuncName(), XpEventData(EventData), GameState, EventID);
}

function EventListenerReturn XpActivateVIP(Object EventData, Object EventSource, XComGameState GameState, Name EventID)
{
	return XpEventResponse(GetFuncName(), XpEventData(EventData), GameState, EventID);
}

function EventListenerReturn XpSuccessfulHack(Object EventData, Object EventSource, XComGameState GameState, Name EventID)
{
	return XpEventResponse(GetFuncName(), XpEventData(EventData), GameState, EventID);
}

function EventListenerReturn XpLowHealth(Object EventData, Object EventSource, XComGameState GameState, Name EventID)
{
	return XpEventResponse(GetFuncName(), XpEventData(EventData), GameState, EventID);
}

function EventListenerReturn XpKillShot(Object EventData, Object EventSource, XComGameState GameState, Name EventID)
{
	return XpEventResponse(GetFuncName(), XpEventData(EventData), GameState, EventID);
}

function EventListenerReturn XpHealDamage(Object EventData, Object EventSource, XComGameState GameState, Name EventID)
{
	return XpEventResponse(GetFuncName(), XpEventData(EventData), GameState, EventID);
}

function EventListenerReturn XpGetShotAt(Object EventData, Object EventSource, XComGameState GameState, Name EventID)
{
	return XpEventResponse(GetFuncName(), XpEventData(EventData), GameState, EventID);
}

function EventListenerReturn XpFirstMissionBonus(Object EventData, Object EventSource, XComGameState GameState, Name EventID)
{
	return XpEventResponse(GetFuncName(), XpEventData(EventData), GameState, EventID);
}