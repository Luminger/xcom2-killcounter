...
Begin:
	...
	{
		kBroadcastWorldMessage = `PRES.GetWorldMessenger().Message(m_sPreppingCallReinforcementsRemovedMessage, Unit.GetLocation(), Unit.GetVisualizedStateReference(), eColor_Bad, , , Unit.m_eTeamVisibilityFlags, , , , class'XComUIBroadcastWorldMessage_UnexpandedLocalizedString');
